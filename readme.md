...
**На данный момент не работает главная функция сайта - поиск новостей. Не забывать про метод prevent у события, чтобы пользователь оставался на страничке для получения SPA-like опыта. В целом - работа выполнена хорошо, необходимо учесть замечания и довести ее до совершенства.**
